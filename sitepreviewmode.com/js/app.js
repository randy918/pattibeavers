...
function init() {
    ...
    function showInfo(data, tabletop) {
        ...
        var suffix;
        var webSite;
        var disableButtonNumber;
        // for (var i = 0; i < data.length; i++) {
        //     spreadsheetRow = data[i].title;
        for (var i = 0; i < data.length; i++) {
            document.getElementById(`${i + 1}-Title`).innerHTML = data[i].title;
            document.getElementById(`${i + 1}-Code`).innerHTML = data[i].prefix + ` ` + data[i].suffix;
            document.getElementById(`${i + 1}-Date`).innerHTML = data[i].date;
            ...
            c(prefixSuffix);
            c(webSite);
            document.getElementById(`${i + 1}-Image`).src = "/assets/" + prefix + "-" + suffix + "-image.jpg";
            c
            document.getElementById(`${i + 1}-ImageDownload`).href = "assets/" + prefix + "-" + suffix + "-email.pdf";
            document.getElementById(`${i + 1}-Pdf`).href = "assets/" + prefix + "-" + suffix + "-email.pdf";
            document.getElementById(`${i + 1}-Print`).href = "assets/" + prefix + "-" + suffix + "-printer.pdf";
            document.getElementById(`${i + 1}-Indesign`).href = "assets/" + prefix + "-" + suffix + "-indesign.zip";
            document.getElementById(`${i + 1}-Web`).href = webSite;
            disableButtonNumber = (`#${i + 1}-Web`);

            if (webSite == "n") {
                $(disableButtonNumber).css("visibility", "hidden")

                //     $(disableButtonNumber).hide();
                // c(disableButtonNumber);

                // c("web no");
                // disableButton = document.getElementById(`${i + 1}-Web`);
                // c(disableButton);
            ...
            // document.getElementById(`${i + 1}"-Printer"`).href = "./assets/" + prefix + "-" + suffix + "-printer.jpg";
            // document.getElementById(`${i + 1}-Web`).href = "./assets/" + prefix + "-" + suffix + "-indesign.zip";
