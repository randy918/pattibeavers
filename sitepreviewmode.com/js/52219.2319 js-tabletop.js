...
// let numbers = [0,9,8,1,2,4,7,8,9,10];
// let even = numbers.filter(isEven)
celciusSubmitted = 24.2;
...
function celciusToFahrenheit(celciusSubmitted) {
    let fahrenheitAnswer = Math.ceil(celciusSubmitted * 9 / 5 + 32);
    c(fahrenheitAnswer);

}

celciusToFahrenheit(celciusSubmitted);
